# MatterSyn historical build and release notes

Archived verbatim from the prior README. Statements and counts below apply to their dated versions; use README.md for current build instructions.
