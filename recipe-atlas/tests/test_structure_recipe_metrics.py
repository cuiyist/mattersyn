...
class StructureRecipeMetricsTests(unittest.TestCase):
    ...
    def test_current_collection_reports_auditable_broad_and_strict_counts_separately(self):
        ...
        self.assertEqual({'recipe_structure_rows':143,'source_groups':34,'records':124,'physical_samples_deduplicated':None},broad['counts'])
        ...
        li2000_rows=[row for row in broad['rows'] if row['source_group']=='li2000cu2sns3']
        self.assertEqual(1,len(li2000_rows))
        self.assertEqual('li2000-cu2sns3-ethylenediamine-solvothermal',li2000_rows[0]['record_id'])
        ...
        self.assertIn('Browse all 143 synthesis–structure rows',page)
        self.assertEqual(143,page.count('Evidence and source locators'))
