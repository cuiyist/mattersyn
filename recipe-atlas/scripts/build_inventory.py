...
def main():
    ...
    body += '<p class="coverage-note"><strong>The full collection’s material and recipe totals are not yet determined.</strong> Titles, extracted text and document counts cannot establish a synthesis recipe. Each retained paper is reviewed with its matching SI and an independent audit. Materials without verified recipes remain blank; no new papers are downloaded.</p>'
