...
def generate(root,snapshot):
    ...
    for folder in [root.parent,dist]:
        ...
        readme.write_text(readme_with_references(readme.read_text(encoding='utf-8')if readme.exists()else'',intro,body),encoding='utf-8')
    ...
    home=dist/'index.html';home.write_text(render_banner(home.read_text(encoding='utf-8'),progress),encoding='utf-8')
