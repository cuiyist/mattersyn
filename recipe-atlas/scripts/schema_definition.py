...
quantity['properties']['minimum_exclusive']={'type':'boolean'}
quantity['properties']['maximum_exclusive']={'type':'boolean'}
...
state=obj({'id':string,'name':string,'kind':{'enum':['stock','mixture','reaction_batch','aliquot','fraction','product','waste','analysis_data','sample_set']},'parent_ids':strings})
