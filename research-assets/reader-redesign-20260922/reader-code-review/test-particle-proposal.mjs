...
const original=fs.readFileSync(path.join(here,'reader-particle-proposal.mjs'),'utf8');
...
fs.writeFileSync(path.join(here,'particle-proposal-tests.json'),JSON.stringify(result,null,2)+'\n');console.log(result);
