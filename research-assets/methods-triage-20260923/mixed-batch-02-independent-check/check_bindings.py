...
for h,f in sources.items():
 pages={1}
 if h.startswith('16aa8f655474'):pages.add(3)
...
report={'started_at':'2026-09-23T13:23:53+00:00','author_freeze_sha256':sha(AUTHOR/'author-freeze.json'),'summary_sha256':sha(AUTHOR/'batch-summary.json'),'bindings':checks,'fresh_original_text_replays':fresh,'raw_text_private':True,'replay_is_not_reading_claim':True,'failures':[]}
