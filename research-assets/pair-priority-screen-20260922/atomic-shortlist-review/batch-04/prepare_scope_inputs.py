...
save(O/'timing-start.json',{'started_at':'2026-09-23T13:17:27+00:00','basis':'Actual clock tool before first batch read','mode':'timed_methods_first_triage','no_paid_processing':True})
current=[]
for x in ranked:
    if x['candidate_inspection_rank']<=35:continue
    ...
    elif g.get('review',{}).get('status')!='queued':reason='current_nonqueued_or_terminal_scope'
