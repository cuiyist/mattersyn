...
validation['visualReview']={'status':'passed','scope':'All 21 actual SVG depictions/cards were rendered and visually inspected. All four 3D JSON-coordinate projections were inspected. Numerical topology/charge/geometry checks are in this report; no browser interaction or experimental geometry validation is claimed.',
...
dump(OUT/'asset-manifest.json',{'sourceDoi':'10.1021/cm9503137','sourceSha256':'cde428b3707ab7e0fe1a24cd747e6c884d6903265d4d745a93e36d60e553321f','summary':registry['summary'],'files':files,
