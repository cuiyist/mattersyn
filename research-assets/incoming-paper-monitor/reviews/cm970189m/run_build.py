...
for name in ['build_dataset.py','build_reader_views.py','build_evidence_views.py','build_paper_reviews.py','build_atlas.py']:
...
for name in ['veinot-protocol.mjs','protocol-visuals.mjs','source-evidence.mjs','paper-review.mjs','chemical-viewer.mjs','material-hub.mjs','material-guide.mjs']:
