// Private integration example only. The site owner decides where to incorporate it.
// The existing crystal-viewer unit-cell/supercell path already accepts the cell JSON.
