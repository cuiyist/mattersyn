...
B=Path(__file__).resolve().parent;S=B.parents[3]/'recipe-atlas';p=S/'.sites-runtime/site-banerjee2003.tar.gz'
with tarfile.open(p,'r:gz') as t:
 ...
 assert 'dist/data/paper-reviews/banerjee2003.json'in names and 'dist/banerjee2003-protocol.mjs'in names
