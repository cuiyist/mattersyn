...
g=json.loads((MON/'ledger.json').read_text(encoding='utf8'))['groups']['10.1021_ja035980c']
manifest={'doi':'10.1021/ja035980c','fingerprint':g['fingerprint'],'documents':[]}
for role,name in [('main','10.1021_ja035980c.pdf'),('si','10.1021_ja035980c_si_1.pdf')]:
 p=ROOT/name
