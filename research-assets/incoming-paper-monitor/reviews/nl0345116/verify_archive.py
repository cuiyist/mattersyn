...
B=Path(__file__).resolve().parent;S=B.parents[3]/'recipe-atlas';p=S/'.sites-runtime/site-sashchiuk2004.tar.gz'
with tarfile.open(p,'r:gz') as t:
 ...
 assert 'dist/data/paper-reviews/sashchiuk2004.json'in names and 'dist/sashchiuk2004-protocol.mjs'in names
