...
B=Path(__file__).resolve().parent;S=B.parents[3]/'recipe-atlas';p=S/'.sites-runtime/site-besson2002.tar.gz'
with tarfile.open(p,'r:gz') as t:
 ...
 assert 'dist/data/paper-reviews/besson2002.json'in names and 'dist/besson2002-protocol.mjs'in names
