...
shutil.copy2(B/'integration-proposal/inventory-summary.json',S/'data/inventory-summary.json')
...
for name in ['nagasaki2004-protocol.mjs','ribeiro2004-protocol.mjs','norberg2004-protocol.mjs','protocol-visuals.mjs','chemical-viewer.mjs','crystal-viewer.mjs','material-guide.mjs']:run([node,'--check',str(S/'dist'/name)])
