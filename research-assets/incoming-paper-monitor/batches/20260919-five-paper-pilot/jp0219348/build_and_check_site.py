...
run([sys.executable,str(H/'build_heo_inventory.py')]);shutil.copy2(O/'inventory-summary.json',S/'data/inventory-summary.json')
...
for name in ['heo2003-protocol.mjs','heo2003-average-viewer.mjs','heo2003-reflection-viewer.mjs','protocol-visuals.mjs','crystal-viewer.mjs','source-evidence.mjs','illustrated-record.mjs']:run([node,'--check',str(S/'dist'/name)])
