"""Independent read-only checks for frozen Heo canonical/reader v2."""
from pathlib import Path
from datetime import datetime,timezone
import json,hashlib,sys,collections,re
A=Path(__file__).resolve().parent;V=A.parent/'v2';H=V.parents[1];S=H.parents[4]/'recipe-atlas'
checks=[];bound={};cache={}
