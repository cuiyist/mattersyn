...
B=Path(__file__).resolve().parent;O=B/'reader-assets/si-numerical-pages03-04';O.mkdir(exist_ok=True)
...
(B/'si-pages03-04-assets.json').write_text(json.dumps(out,indent=2)+'\n',encoding='utf8')
print(json.dumps({'pages':[3,4],'assets':len(assets),'dimensions':assets[0]['pixels']}))
