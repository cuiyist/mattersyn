...
inputs={str(p):sha(p) for p in [B/'source-extraction-revision-2/source-extraction-freeze.json',B/'source-inventory.json',B/'source-extraction-revision-2/source-facts.json',B/'page-coverage.json',B/'selected-original-assets.json',C/'record-manifest.json',C/'source-to-field-coverage.json',SITE/'scripts/build_paper_reviews.py',SITE/'dist/source-evidence.mjs']}
