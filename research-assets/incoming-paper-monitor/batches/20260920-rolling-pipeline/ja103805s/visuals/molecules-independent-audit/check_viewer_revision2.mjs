...
const read=name=>JSON.parse(fs.readFileSync(new URL(['bindings-proposal.json','material-slot-map.json'].includes(name)?'revision-2/'+name:name,input),'utf8'));
...
fs.writeFileSync(new URL('viewer-revision2-function-audit.json',out),JSON.stringify(report,null,2)+'\n');console.log(JSON.stringify(report));
