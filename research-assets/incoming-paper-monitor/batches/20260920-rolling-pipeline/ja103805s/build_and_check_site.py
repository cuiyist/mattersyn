...
run([sys.executable,str(H/'build_evans_inventory.py')]);shutil.copy2(O/'inventory-summary.json',S/'data/inventory-summary.json')
...
for name in ['evans2010-protocol.mjs','protocol-visuals.mjs','crystal-viewer.mjs','source-evidence.mjs','illustrated-record.mjs']:run([node,'--check',str(S/'dist'/name)])
