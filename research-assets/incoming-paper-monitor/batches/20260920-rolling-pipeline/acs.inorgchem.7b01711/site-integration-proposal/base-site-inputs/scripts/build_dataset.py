...
def render_record(r,meta):
    ...
    links=[dict(l,url=('../'+l['url'] if l['url'].startswith('paper-review.html') else record_href(l['url'])),relation=('Source document review' if r['lineage']['source_group']=='evans2010' and l['relation']=='source_reader_pending_independent_audit' else l['relation'])) for l in r['context_links']]
