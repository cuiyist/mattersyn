...
(O/'mechanical-checks-v1.json').write_text(json.dumps(report,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
(O/'independent-table-tokens.json').write_text(json.dumps({'basis':report['expected_table_basis'],'tables':expected},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
