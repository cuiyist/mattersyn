...
v=read(O/'science-release-anonymous-verification.json');assert v['status']=='passed' and v['site_commit']=='22e894390eae26cfcf4eb84c4c69157f49cf617b'
p=S/'data/paper-reviews/morrison2017.json';before=O/'reader-before-publication-labels.json';assert not before.exists();shutil.copy2(p,before);d=read(p)
...
d['audit_details']['first_verified_public_release']={'dataset_version':'0.26.0','site_commit':v['site_commit'],'built_at':v['build']['updated_at'],'anonymous_checks':47,'scope':'Scientific contribution before this publication-status metadata update; scientific values are unchanged.'}
