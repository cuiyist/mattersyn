...
names=['MEMORY.md','README.md','REFERENCES.md','recipe-atlas/data/paper-reviews/friedfeld2019.json','research-assets/verify_public_delivery.py','research-assets/github-public-delivery-verification.json','research-assets/github-publication-checkpoint.json','research-assets/github-public-site-sync.json','research-assets/reference-readme-generation.json']
names+=['research-assets/incoming-paper-monitor/'+n for n in ['ledger.json','latest-publication.json','public-progress-editorial.json','queue-status.json','queue-status.md','queue-status.html','deadline-20260920/active-cutoff.json','deadline-20260920/friedfeld-published-scope-20260920.json']]
...
for folder in [F,F.parent/'acs.jpcc.5c05144',M/'skills']:
