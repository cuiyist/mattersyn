...
assert (D/'.git').is_dir()
names=['MEMORY.md','README.md','REFERENCES.md','research-assets/verify_public_delivery.py','research-assets/incoming-paper-monitor/deadline-20260920/pati-review-scope-20260920.json','research-assets/reference-readme-generation.json','research-assets/github-public-delivery-verification.json','research-assets/github-publication-checkpoint.json','research-assets/github-public-project-sync.json','research-assets/github-public-site-sync.json']
...
files += [p for p in [MON/'deadline-20260920/pati-published-scope-20260920.json'] if p.is_file()]
folders=[L,L.parent/'acsanm.2c04342',L.parent/'intake-20260920T114139Z',MON/'deadline-20260920/admission-20260920T114139Z',M/'skills',M/'recipe-atlas/data',M/'recipe-atlas/dist',M/'recipe-atlas/scripts']
