...
const report={status:'passed',author:'/root/backlog_eta',check_count:checks,
 ...
 scope:'Actual chemicalEntry function exercised for all 45 proposed slots. False gates return unmodified base entries; in-memory true-gate simulation applies only the permitted display overrides. The saved bindings remain unapproved. This is not browser, publication or independent scientific approval.',
