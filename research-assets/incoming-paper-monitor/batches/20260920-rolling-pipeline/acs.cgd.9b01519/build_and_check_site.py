...
run([sys.executable,str(H/'build_sommer_inventory.py')]);shutil.copy2(O/'inventory-summary.json',S/'data/inventory-summary.json')
...
for name in ['sommer2020-protocol.mjs','protocol-visuals.mjs','crystal-viewer.mjs','source-evidence.mjs','illustrated-record.mjs']:run([node,'--check',str(S/'dist'/name)])
