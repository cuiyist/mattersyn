...
const manifest=JSON.parse(fs.readFileSync(path.resolve(P,'../../canonical-proposal/v1/record-manifest.json'),'utf8'));
...
fs.writeFileSync(path.join(O,'viewer-checks-v1.json'),JSON.stringify(result,null,2)+'\n');
