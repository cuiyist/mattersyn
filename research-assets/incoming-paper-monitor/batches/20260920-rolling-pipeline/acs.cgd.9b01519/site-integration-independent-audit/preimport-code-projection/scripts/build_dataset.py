...
def product_reader_note(note,record):
    prefix='Source context object: ' if record['lineage']['source_group'] in {'ghosh2012','sommer2020'} else 'Source sample object: '
    if record['lineage']['source_group'] not in {'lian2021','ghosh2012','sommer2020'} or not note.startswith(prefix):return '<p>'+esc(note)+'</p>'
