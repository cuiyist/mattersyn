...
('tauc-axes','Printed Tauc ordinate labels','(alpha*h*nu)^2; units printed with exponent1/2','si',8,'FigureS4b axes','cubic/rhombohedral optical gaps','Retain original axis typography;no newly derived fit points or gaps.',['figure-s4'])]:equations.append({'id':i,'title':title,'expression':expr,'sample_scope':scope,'scope_note':notes,'evidence':[ev(d,p,l)],'asset_ids':assets})
