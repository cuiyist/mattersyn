...
ck(slots===55,'All 55 slots executed');ck(api.chemicalEntry(data,'other-paper','oa')===undefined,'Cross-source exclusion');
ck(api.chemicalEntry(data,[...records.keys()][0],'unmapped')===undefined,'Unmapped slot exclusion');
for(const raw of entries.values()){
 const e={...raw,sourceBindingCaption:'Independent test source context for '+raw.id};
...
ck(stockTransitions===15&&contextTransitions===15,'All 30 component transitions executed');
ck(dialogs===28&&threeD===7,'All 28 identities including 7 entries using 6 conformers');
