...
P=Path(__file__).resolve().parent;I=P.parent/'intake-20260920T141934Z/intake-manifest.json'
sha=lambda p:hashlib.sha256(Path(p).read_bytes()).hexdigest()
row=next(x for x in json.loads(I.read_text('utf8'))['papers'] if x['paper_id']=='legacy::10.1021_acs.jpcc.5c05144')
assert row['source_generation']==1 and row['bundle_sha256']=='60981509bcd71286c99c1795e7ef6eb803310e24d22bbb9f7a26299f10b427ab'
...
res={'schema':'mattersyn-source-preparation/1','author':'/root/peng1998_reader_assets','at':datetime.now(timezone.utc).isoformat(),'doi_candidate':'10.1021/acs.jpcc.5c05144','source_generation':1,'bundle_sha256':row['bundle_sha256'],'intake_manifest':{'path':str(I),'sha256':sha(I)},'documents':docs,'renderer':'pypdfium2/PDFium at 150 dpi; text from pypdf layout extraction','coverage_status':'prepared_only_not_yet_read','source_originals_unchanged':True}
