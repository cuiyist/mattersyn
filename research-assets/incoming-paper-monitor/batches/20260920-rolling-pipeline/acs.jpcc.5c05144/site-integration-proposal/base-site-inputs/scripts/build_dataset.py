...
def render_record(r,meta):
    ...
    links=[dict(l,label=('Source document review' if r['lineage']['source_group']=='friedfeld2019' and l['relation']=='private_unapproved_reader' else l['label']),url=('../'+l['url'] if l['url'].startswith('paper-review.html') else record_href(l['url'])),relation=('Source document review' if (r['lineage']['source_group'],l['relation']) in {('evans2010','source_reader_pending_independent_audit'),('morrison2017','private_reader_pending_independent_review'),('lian2021','private_unapproved_reader_proposal'),('ghosh2012','private_unapproved_reader_proposal'),('sommer2020','private_unapproved_reader_proposal'),('matuhina2023','private_unapproved_reader_proposal'),('pati2009','private_unapproved_reader'),('friedfeld2019','private_unapproved_reader')} else l['relation'])) for l in r['context_links']]
