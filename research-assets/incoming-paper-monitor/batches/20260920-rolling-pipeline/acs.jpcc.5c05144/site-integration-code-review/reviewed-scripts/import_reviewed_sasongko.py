...
reader=read(P/'reader/sasongko2025.json');reader['presentation_gates']['site_integration']=True;reader['publication_status']='Source-reviewed contribution integrated locally; browser and publication remain separate.';reader['audit_details']['promotion_audit_sha256']=sha(auditpath);save(S/'data/paper-reviews/sasongko2025.json',reader)
changes=[]
