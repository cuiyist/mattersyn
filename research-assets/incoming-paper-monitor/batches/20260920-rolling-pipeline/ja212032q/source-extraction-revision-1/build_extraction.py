...
{'id':'equation-average-main','expression':'T_avg = sum_m(a_m*T_m^2) / sum_n(a_n*T_n)','meaning':'Amplitude-weighted average lifetime; fit amplitudes need not be the SI normalized printed means.','scope':'lifetime-acquisition','evidence':[ev('main',2,'Lifetime Measurements displayed equation'),ev('main',3,'Equation symbol definition')],'asset_ids':['equation-average-main']},
...
('figure-1','main',5,(.52,.226,.902,.434)),('figure-2','main',7,(.524,.417,.896,.689)),('figure-3','main',8,(.54,.081,.88,.632)),('figure-4','main',9,(.111,.281,.474,.496)),
('figure-s1','si',2,(.128,.205,.719,.361)),('figure-s2','si',2,(.121,.50,.833,.819)),('figure-s3','si',3,(.116,.182,.477,.286)),
('figure-s4','si',3,(.116,.354,.518,.795)),('figure-s4-caption-continuation','si',4,(.115,.089,.887,.182)),
