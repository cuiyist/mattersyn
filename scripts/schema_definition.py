...
measurement=obj({'id':string,'sample_id':string,'property':string,'technique':string,'value':ref('quantity'),'conditions':string,'derives_from':strings,'evidence':arr(evidence)})
